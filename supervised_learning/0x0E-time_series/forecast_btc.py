...
class WindowGenerator():
    ...
    def __init__(self, input_width, label_width, shift,
        ...
        """
        Class constructor. Sets input and label sizes.
        """
        # Store the raw data.
        ...
        self.input_indices = np.arange(total_window_size)[self.input_slice]

        self.label_start = total_window_size - self.label_width
        self.labels_slice = slice(self.label_start, None)
        self.label_indices = np.arange(total_window_size)[self.labels_slice]

    def split_window(self, features):
        """Splits features as inputs and labels for training."""
    ...
    def plot(self, model=None, plot_col='T (degC)', max_subplots=3):
        """Plots input data and model prediction."""
    ...
    def __repr__(self):
        """String representation for class objects."""
        return '\n'.join([
...
def lstm_model():
    ...
    lstm = tf.keras.models.Sequential([
        ...
        tf.keras.layers.LSTM(24, input_shape=[24, 7],
...
def compile_and_fit(model, window, patience=2):
    """Compiles and fits the model to data."""
